...
const Footer = () => {
  return (
    <div className="w-full h-[34.6875rem] bg-white relative mt-[1.5rem]">
      <div className="w-full relative">
        <img src={Group1} alt="" className="opacity-30 h-[33rem]" />
        <img
          src={CloudFooter}
          alt=""
          className="absolute right-0 top-0 h-[37rem]"
        />
        <div className="absolute top-[3.75rem] left-[5rem]">
          <img src={Logo_black} alt="" />
        </div>
        <div className="absolute top-[11.44rem] left-[6.25rem]">
          <div className="flex items-start gap-x-[7.5rem]">
            <div className="left">
        ...
        <div className="absolute top-[25.81rem] left-[6.25rem]">
          <div className="trip_font text-[1rem] font-bold ">
        ...
        <div className="absolute top-[34.81rem] left-[6.25rem]">
          <LineFooter></LineFooter>
          <div className="trip_font text-[0.875rem] font-bold text-center mt-[0.94rem] pb-[2.5rem]">
